# Open questions — 2026-08-11

*Computed, not summarised. These are the leads that SURVIVED this week's debunking. Research targets — the system has no predictive power and none of this is a buy signal.*

## 1. Where the research and the price disagree

*The only place a variant view can exist. Strong on the filings AND still in the cheaper half — everything else is already consensus.*

| Ticker | Positioned | Cheap vs all | Cheap vs sector | Improving | P/E |
|---|---|---|---|---|---|
| **BKR** | 87% | 66 | 63 | 10 | 21 |
| **OIS** | 71% | 66 | 62 | 63 | n/m |
| **SO** | 86% | 65 | 40 | 28 | 23 |
...
- **COPX +19.1%/21d** (Copper Miners) — equity attention absent: Metal Mining rank 72/130, Other Metals and Minerals rank 118/130
...
*Generated mechanically from this week's pack, price table and deep rankings. It exists because a human summary once reported a week as 'nothing to do' while these leads sat unread in the outputs.*